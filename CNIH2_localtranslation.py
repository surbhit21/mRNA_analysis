...
def PlasticityExperimentGauss(x_grid,params,param_names, locns, sigmas, factors,up_or_down,step_num,op_dir,dt,dx):
    ...
    plt.show()
    return new_pa
def patterson2010GluA1Plasticity(dp_arr,vp_arr,kp_arr,betap_arr,mrna_arr,jpin,dx,x_grid,location):
    """
    ...
    t_step0 = 5*60  # running for t_step0 secs
...
# breakpoint()
patterson2010GluA1Plasticity(dP_array,
                             vP_array,
                             kP_array,
                             betaP_array,
                             mRNA_arr,
