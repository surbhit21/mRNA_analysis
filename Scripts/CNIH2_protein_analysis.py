...
class CNHI2DataAnalysis():
    def __init__(self, DataFolder):
        ...
        self.DAPI_channel = 0
        self.MAP2_channel = 1
        self.CNIH2_channel = 3
        self.Glua2_channel = 2
...
CNIH2_length_data, Glua2_length_data,CNIH2_length_density, Glua2_length_density,\
            ratio_CNIH2_GluA2,total_ratio_CNIH2_GluA2, \
                CNIH2_df,Glua2_df,raw_CNIH2_data,raw_Glua2_data,MAP2_length_data,soma_MAP2_data,CNIH2_bg,Glua2_bg = G2DA_c.LoadData(bins,18,exclude_cells=[])
