...
#         """
#         self.df = DataFolder
#         self.molecules = ["DAPI", "CNIH2", "MAP2", "GluA2"];  # order of channels
#         self.DAPI_channel = 0
#         self.CNIH2_channel = 1
#         self.MAP2_channel = 2
...
#                     Glua2_data = self.ReadCSVFull(Glua2_fname + "/" + sdx)
#                     MAP2_data = self.ReadCSVFull(MAP2_fname + "/" + rdx)
#                     # breakpoint()
#
...
#                CNIH2_df, Glua2_df, raw_CNIH2_data, raw_Glua2_data, MAP2_length_data, soma_MAP2_data, CNIH2_bg, Glua2_bg
...
G2DA_c = CNHI2DataAnalysis("/Users/surbhitwagle/Desktop/Surbhit/Work/PhD/2020/PhD/MPIBR/PhD-Project/Experimental_collab/Anne-Sophie/Protein/CNIH2_new/cells")

CNIH2_length_data, Glua2_length_data,CNIH2_length_density, Glua2_length_density,\
            ratio_CNIH2_GluA2,total_ratio_CNIH2_GluA2, \
                CNIH2_df,Glua2_df,raw_CNIH2_data,raw_Glua2_data,raw_MAP2_data,MAP2_length_data,soma_MAP2_data,CNIH2_bg,Glua2_bg = G2DA_c.LoadData(bins,18,exclude_cells=[])
...
plot_velocity_impact(fitted_vals[0], fitted_vals[1],COLORS_dict["shaft_i"],
                     "Normlized_intesity_Dend_dist_GluA2_full_",prefix="Theory fit: ",y_lim=False)
